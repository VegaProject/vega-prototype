...
contract Quorum is Ownable {
    ...
    returns (uint offerId)
  {
    ...
    o.executed = false;
    o.numberOfVotes = 1;
    o.offerHash = sha3(_quorum, _description, _openFor, _offerHash);
    return offerId;
  }
  ...
  {
    Offer o = offers[_id];
    return o.offerHash == sha3(_quorum, _description, _openFor, _offerHash);
  }
  ...
  function checkIfOfferCanExecute(uint _id, bytes _transactionBytecode) private constant returns (bool) {
    Offer o = offers[_id];
    if (now < o.openFor || o.executed || o.offerHash != sha3(o.quorum, o.description, o.openFor, _transactionBytecode)) throw;
